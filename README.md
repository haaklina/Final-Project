...
Phylogenetic tree explains bioluminescent groups are Ostracoda_bioluminescent,Leiognathidae(Ponyfish),Euprymna_scolopes(Squid), andAnomalops_katoptron(Flashlight fish).  Non-luminous groups are included for contrast assister taxa.2
